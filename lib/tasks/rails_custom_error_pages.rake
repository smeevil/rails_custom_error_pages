namespace :rcep do
  ...
  task :update do
    system "script/plugin install -f git://github.com/smeevil/rails_custom_error_pages.git && git add . && git commit -a -m 'Updated rails_custom_error_pages to latest version'"
  end
end